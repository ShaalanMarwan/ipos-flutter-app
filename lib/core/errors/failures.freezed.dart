...
mixin _$Failure {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, String? syncId) sync,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String message, int? statusCode, dynamic data)? server,
    TResult? Function(String message)? cache,
    TResult? Function(String message)? network,
    TResult? Function(String message, String? syncId)? sync,
...
class _$ServerFailureImpl implements ServerFailure {
  const _$ServerFailureImpl(
      {required this.message, this.statusCode, this.data});
  ...
  TResult when<TResult extends Object?>({
    ...
    return server(message, statusCode, data);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return server?.call(message, statusCode, data);
  }
...
abstract class ServerFailure implements Failure {
  const factory ServerFailure(
      ...
      final int? statusCode,
      final dynamic data}) = _$ServerFailureImpl;
...
abstract class _$$SyncFailureImplCopyWith<$Res>
  ...
  @override
  @useResult
  $Res call({String message, String? syncId});
}
...
class _$SyncFailureImpl implements SyncFailure {
  const _$SyncFailureImpl({required this.message, this.syncId});
  ...
  @override
  String toString() {
    return 'Failure.sync(message: $message, syncId: $syncId)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, message, syncId);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return sync?.call(message, syncId);
  }
...
abstract class SyncFailure implements Failure {
  const factory SyncFailure(
      {required final String message,
      final String? syncId}) = _$SyncFailureImpl;
